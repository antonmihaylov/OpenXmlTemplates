...
namespace OpenXMLTemplates.ControlReplacers.DropdownControlReplacers
{
    ...
    /// value of the referenced variable. If it's evaluated to true (aka is true, "true", 1, "1", non-empty list, non-empty dict)
    ...
    ///     - GREATER OR LESS THAN - tag name: "conditional_variableidentifier_gt_variableidentifier" or "conditional_variableidentifier_lt_2"
    ///     - EQUALS - tag name: "conditional_variableidentifier_eq_variableidentifier" or "conditional_variableidentifier_eq_2"
    ///     - NOT - tag name: "conditional_variableidentifier_not_or_variableidentifier" or "conditional_variableidentifier_not"
    /// </summary>
