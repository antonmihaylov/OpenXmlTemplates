...
namespace OpenXMLTemplates.ControlReplacers
{
    ...
    /// If the variable value is evaluated to true (True, "true", 1, "1", non-empty list, non-empty dict) the control stays.
    ...
    ///    - GREATER OR LESS THAN - tag name: "conditional_variableidentifier_gt_variableidentifier2" or "conditional_variableidentifier_lt_2"
    ///    - EQUALS - checks if two values match - tag name: "conditional_variableidentifier_eq_variableidentifier2" or "conditional_variableidentifier_eq_2"
    ///    - NOT - negates the last value - tag name: "conditional_variableidentifier_not_or_variableidentifier2" or "conditional_variableidentifier_not"
    ///</summary>
